// CPictureCtrlDemo.cpp : Defines the class behaviors for the application.
//
...
// CCPictureCtrlDemoApp-construction
...
// The one and only CEyeLoggingApp object

CCPictureCtrlDemoApp theApp;


// CCPictureCtrlDemoApp-initialization
